          ...
          <section className="bg-slate-800 rounded-xl overflow-hidden shadow-lg border border-slate-700">
            ...
            <div className="p-4 text-sm text-slate-300 space-y-3">
              ...
              <ul className="list-disc list-inside space-y-2">
                <li><strong className="text-white">ด่าน 1: กรองเทรนด์ (กราฟ Day)</strong> - ราคาและเส้น EMA50 ต้องอยู่สูงกว่า EMA200 (สำหรับหาจังหวะ BUY ในขาขึ้น) หรืออยู่ต่ำกว่า EMA200 (สำหรับหาจังหวะ SELL ในขาลง) เพื่อจับเทรนด์ที่ชัดเจนที่สุด</li>
                <li><strong className="text-white">ด่าน 2: หาจุดเข้า (กราฟ H4)</strong> - รอให้กราฟย่อ/เด้ง กลับมาจนค่า RSI(14) ตกมาอยู่ในโซนพักตัว (35-55 สำหรับ BUY หรือ 45-65 สำหรับ SELL) แล้วงัดกลับไปตามเทรนด์เดิม</li>
